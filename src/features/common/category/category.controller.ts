...
} from "@/features/common/category/commands/create-category/create-category.response";
...
import {
    GetCourseCategoriesByIdQuery
} from "@/features/common/category/queries/get-categories-by-id/get-categories-by-id.query";
import {
    GetCourseCategoriesByIdResponse
} from "@/features/common/category/queries/get-categories-by-id/get-categories-by-id.response";
...
export class CategoryController {
    ...
    async getAll(@Query() payload: GetCourseCategoriesRequest) {
        return await this.queryBus.execute(
            new GetCourseCategoriesQuery(payload.search),
        );
    }
    ...
    async create(@Body() payload: CreateCourseCategoryRequest) {
        return await this.cmdBus.execute(
            new CreateCourseCategoryCommand(payload.title),
        );
    }
    ...
    async update(
        ...
        return await this.cmdBus.execute(
            new UpdateCourseCategoryCommand(id, payload.title),
        );
    }
