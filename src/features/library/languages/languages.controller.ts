...
import {
    GetLanguagesByIdQuery
} from "@/features/library/languages/queries/get-languages-by-id/get-languages-by-id.query";
import {
    GetLanguagesByIdResponse
} from "@/features/library/languages/queries/get-languages-by-id/get-languages-by-id.response";
...
export class LanguagesController {
    ...
    async create(@Body() payload: CreateLanguageRequest) {
        return await this.cmdBus.execute(new CreateLanguageCommand(payload.title, payload.code));
    }
    ...
    async update(
        ...
        return await this.cmdBus.execute(new UpdateLanguageCommand(id, payload.title, payload.code));
    }
