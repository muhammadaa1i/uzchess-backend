...
import {
    GetCategoriesByIdQuery
} from "@/features/library/category/queries/get-categories-by-id/get-categories-by-id.query";
import {
    GetCategoriesByIdResponse
} from "@/features/library/category/queries/get-categories-by-id/get-categories-by-id.response";
...
export class CategoryController {
    ...
    async update(
        ...
        return await this.cmdBus.execute(new UpdateCategoryCommand(id, payload.title));
    }
